...
for(const link of document.querySelectorAll('.skip-links a'))link.addEventListener('click',e=>{e.preventDefault();document.querySelector(link.getAttribute('href')).focus();});
