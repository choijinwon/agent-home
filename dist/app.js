...
let voiceGuide=null,voiceRefresh=null,commute=null;
...
$('#open-map').onclick=()=>{
 ...
 $('#map-dialog').showModal();motionDemo.reset(settings);$('#close-map').focus();
};
